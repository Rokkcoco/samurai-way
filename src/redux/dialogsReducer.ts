...
const dialogsReducer = (state: DialogsPageType = initialState, action: DialogsReducerActionsType): DialogsPageType => {
    switch (action.type) {
        case SEND_MESSAGE:
...
type DialogsReducerActionsType = sendMessageActionType
